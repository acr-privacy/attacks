...
PROJECT_NAME = fingerprint_generation
...
## Prepare the dataset artifacts
prepare-datasets: data/datasets.tar.gz.part1 data/datasets.tar.gz.part2
	cat data/datasets.tar.gz.part* | tar -xzvf - --directory=${FINGERPRINT_ROOT}
...
eval-speakers: eval-libri-speakers

eval-libri-speakers:
	${PROJECT_DIR}/src/attacking/eval_speakers.sh ${PROJECT_DIR} ${EXPERIMENT_ROOT}/speakers/librispeech "LIBRISPEECH"
