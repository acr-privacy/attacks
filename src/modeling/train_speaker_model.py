...
from features.acrcloud import preprocess_acrcloud_speaker_dataset
from features.sonnleitner import preprocess_sonnleitner_speaker_dataset
from features.zapr1 import preprocess_zapr1_speaker_dataset
from features.zapr2 import preprocess_zapr2_speaker_dataset


def run_speaker_experiment(
    model: keras.Model,
    datadir: Path,
    outdir: Path,
    method: str,
    ...
    extract_functions = {
        "acrcloud": preprocess_acrcloud_speaker_dataset,
        "sonnleitner": preprocess_sonnleitner_speaker_dataset,
        "zapr_alg1": preprocess_zapr1_speaker_dataset,
        "zapr_alg2": partial(preprocess_zapr2_speaker_dataset, n_bits=n_bits),
    }

    meta, x, y = extract_functions[method](
        datadir / method, split=split, seq_len=seq_len
    )
